...
class MyTopo( Topo ):
    def __init__( self ):
        ...
        # connect the user device and their dish together (the delay should be negligible) (CHANGE loss here)
...
def set_link_properties(net, node1, node2, bw, delay, max_queue_size=switch_queue_size):
    ...
    #exjobb smoot_change should be true. If smoot change changes to false the results are all over the place
...
def main():
    ...
    #exjobb
    # - https://stackoverflow.com/questions/54459512/how-to-send-a-command-with-the-python-mininet-api
